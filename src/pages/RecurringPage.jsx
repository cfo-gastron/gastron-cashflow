  ...
  async function handleAdd() {
    ...
    try {
      ...
      const rec = await addRecurring({
        name: rName, amount: parseFloat(rAmount), type: rType, account: rAccount,
        cat_id: rCatId||null, cat_name: cat?.name||null,
        subcat_id: rSubcatId||null, subcat_name: subcat?.name||null,
        week_of_month: parseInt(rWom), start_month: parseInt(rStart), end_month: parseInt(rEnd),
      })
